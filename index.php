...
$select_banners_result = mysqli_query($db_con, $select_banners);
...
<!-- Header -->
<header id="header">
  <div class="intro" style="background: url('uploads/banners/<?php echo $after_assoc_banners['banner_image'] ?>') center center no-repeat;">
    <div class="overlay">
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            <h1><?php echo $after_assoc_banners['banner_title'] ?></h1>
            <p><?php echo $after_assoc_banners['banner_desc'] ?></p>
            <a href="#about" class="btn btn-custom btn-lg page-scroll"><?php echo $after_assoc_banners['banner_btn'] ?></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<div id="services">
  <div class="container">
    ...
    <?php foreach($select_banners_result as $service){ ?>

      <div class="col-md-4">
        <div class="service-media"> <img src="uploads/banners/<?php echo $service['banner_image'] ?>" alt=" "> </div>
        <div class="service-desc">
          <h3><?php echo $service['banner_title'] ?></h3>
          <p><?php echo $service['banner_desc'] ?></p>
        </div>
      </div>
    <?php } ?>
      ...
      <div class="portfolio-items">
        <div class="col-sm-6 col-md-4 col-lg-4">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="img/portfolio/01-large.jpg" title="<?php echo $after_assoc_banners['banner_btn'] ?>" data-lightbox-gallery="gallery1">
  ...
  <div class="container">
    <div class="col-md-8">
      <div class="row">
        ...
        <form "www.form.asgnepal.org/display.php" method="post">
          <div class="row">
            <div class="col-md-6">
